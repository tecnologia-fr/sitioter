...
async function createLeadCorredora(formData: FormData) {
  ...
  const { data, error } = await resend.emails.send({
    ...
    to: "contacto@terinversiones.cl",
    subject: "Nuevo lead de TER",
    html: `
      <h1>Nuevo lead de TER</h1>
...
export function ContactFormTer() {
  return (
    <div className="min-h-screen">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/TER_Contacto.jpg')`,
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-start items-center  text-center px-4 pt-20 lg:pt-44">
          <h1 className="text-white text-5xl lg:text-7xl md:text-6xl font-bold mb-4">
            Contáctanos
          </h1>
          <p className="text-white lg:text-4xl text-2xl  mb-8 font-light">
            Estamos listos para ofrecerte la mejor solución acorde a{" "}
            <span className="underline decoration-destacado decoration-4 underline-offset-8 font-black">
              tus necesidades
            </span>
          </p>
        </div>
        ...
        <div className="absolute lg:top-0 -bottom-16 left-1/2 transform -translate-x-1/2 translate-y-1/2 z-20 w-full max-w-6xl px-4">
